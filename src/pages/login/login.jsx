...
const Login = () => {
  return (
    <div>
      <section class=" darkk:bg-gray-900">
                  ...
                  <div class="flex items-center justify-between">
                      <div class="flex items-start">
                          ...
                          <div class="ml-3 text-sm">
                            <label for="remember" class="text-gray-500 darkk:text-gray-300">Remember me</label>
                          </div>
                      </div>
                      <a href="#" class="text-sm font-medium text-primary-600 hover:underline darkk:text-primary-500">Forgot password?</a>
                  </div>
                  <button type="submit" class="w-full text-white bg-[blue] hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center darkk:bg-primary-600 darkk:hover:bg-primary-700 darkk:focus:ring-primary-800">Sign in</button>
                  <p class="text-sm font-light text-gray-500 darkk:text-gray-400">
                      Don’t have an account yet? <a href="/register" class="font-medium text-primary-600 hover:underline darkk:text-primary-500">Sign up</a>
                  </p>
              </form>
          </div>
      </div>
